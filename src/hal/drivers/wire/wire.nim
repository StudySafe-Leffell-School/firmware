...
proc constructTwoWire*(busNum: uint8): TwoWire {.constructor,
    importcpp: "TwoWire(@)".}
...
proc setPins*(this: var TwoWire; sda: cint; scl: cint): bool {.importcpp: "setPins",
    header: "wire.h".}
proc begin*(this: var TwoWire; sda: cint; scl: cint; frequency: uint32 = 0): bool {.
    importcpp: "begin".}
proc begin*(this: var TwoWire; slaveAddr: uint8; sda: cint; scl: cint; frequency: uint32): bool {.
    importcpp: "begin".}
...
proc setBufferSize*(this: var TwoWire; bSize: csize_t): csize_t {.
    importcpp: "setBufferSize".}
...
proc beginTransmission*(this: var TwoWire; address: uint16) {.
    importcpp: "beginTransmission".}
proc beginTransmission*(this: var TwoWire; address: uint8) {.
    importcpp: "beginTransmission".}
proc beginTransmission*(this: var TwoWire; address: cint) {.
    importcpp: "beginTransmission".}
proc endTransmission*(this: var TwoWire; sendStop: bool): uint8 {.
...
proc requestFrom*(this: var TwoWire; address: uint16; size: uint8; sendStop: bool): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: uint16; size: uint8; sendStop: uint8): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: uint8; len: csize_t; stopBit: bool): csize_t {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: uint16; size: uint8): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: uint8; size: uint8; sendStop: uint8): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: uint8; size: uint8): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: cint; size: cint; sendStop: cint): uint8 {.
    importcpp: "requestFrom".}
proc requestFrom*(this: var TwoWire; address: cint; size: cint): uint8 {.
    importcpp: "requestFrom".}
...
proc onRequest*(this: var TwoWire; a2: proc ()) {.importcpp: "onRequest",
    header: "wire.h".}
proc slaveWrite*(this: var TwoWire; a2: ptr uint8; a3: csize_t): csize_t {.
    importcpp: "slaveWrite".}
